...
const CalendarIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g mask="url(#c)">
      <path fill="url(#d)" d="M32 27.2C32 16.596 40.596 8 51.2 8h89.6c10.604 0 19.2 8.596 19.2 19.2V96H32z" filter="url(#e)"/>
    </g>
...
export function CalendarConnectionStatus() {
  const { status, connecting, error, connect, disconnect } = useGoogleCalendar()
  ...
  if (status === "connected") {
    return (
      <button
        ...
        className="relative p-0 bg-transparent border-none cursor-pointer hover:opacity-70 transition-opacity"
